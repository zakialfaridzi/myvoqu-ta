...
(3, 2, '1579687251', 91, 91, 'zalfaridzi', '', 'default.png'),
...
(34, 'asdasd', '6066df8f97461.mkv', '<div class=\"video-wrapper\"><video class=\"post-video\" controls width=\"500\" height=\"500\"><source src=http://localhost/myvoqu/assets_user/file_upload/6066df8f97461.mkv type=\"video/mp4\"></video></div>', '1617354639', 91);
...
(226, 'Proident quis id qu', 94, '', '6066ddc1318e4.mkv', '<div class=\"video-wrapper\"><video class=\"post-video\" controls><source src=http://localhost/myvoqu/assets_user/file_upload/6066ddc1318e4.mkv type=\"video/mp4\"></video></div>', '1617354177'),
(227, 'Dolor nostrum lorem', 95, '', '6066e022d7b0c.mkv', '<div class=\"video-wrapper\"><video class=\"post-video\" controls  width=\"500\" height=\"500\"><source src=http://localhost/myvoqu/assets_user/file_upload/6066e022d7b0c.mkv type=\"video/mp4\"></video></div>', '1617354786');
...
(91, 'zalfaridzi', 'Male', 'jaki@gmail.com', 'Zaki_Al_Faridzi_Formal_Photo1.jpg', '$2y$10$VPWRjJtMRr1FLWpVAC91QuIgLOKATtll33owfV52VSJztS0Zt6Udy', 1, 1, 1579687251, 'offline-dot', '0000-00-00', '', '', '', '', '', 0),
(94, 'Lareina Langley', 'Female', 'zack.ridzi@gmail.com', 'default.png', '$2y$10$e/AUDwc6WYpgnZYlyCJCsu8xtykPN4XEQJHun9x6lyAT6ppM0rbbO', 2, 1, 1617354021, 'offline-dot', '0000-00-00', '', 'Hello World!', '', '', '', 0),
(95, 'Sydnee House', 'Male', 'xitcfdhnpxttzaifpw@twzhhq.com', 'default.png', '$2y$10$agYqGrCqvbMMsjyaaRY46eQzrKRsRvsuwHZPePLg/3T6VlOiWPHQ6', 3, 1, 1617354269, 'offline-dot', '0000-00-00', '', 'Hello World!', '', '', '6066de1d266a9.jpg', 1);
...
--
ALTER TABLE `notification`
  MODIFY `id_notification` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=283;
...
--
ALTER TABLE `posting`
  MODIFY `id_posting` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=228;

--
-- AUTO_INCREMENT for table `report`
--
ALTER TABLE `report`
  MODIFY `id_report` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `suka`
--
ALTER TABLE `suka`
  MODIFY `id_suka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;

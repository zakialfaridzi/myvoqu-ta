...
SELECT * FROM postgen p join user u on p.id_user=u.id order by id_posting DESC;
end$$
...
(15, 'hai\n', 'Ustad Zaki', '2021-06-14 15:14:57', 165),
(16, 'hai juga', 'Surya Nurhalimah', '2021-06-14 15:18:56', 146);
...
(53, 2, '1618314853', 131, 131, 'ADMIN - Zaki', 'Hello World!', 'IMG_2686.JPG'),
...
INSERT INTO `group_comment` (`id_comment`, `comment`, `id_posting`, `date`, `id_user`) VALUES
(4, 'Merdu sekali pak Asep ', 24, '0000-00-00 00:00:00', 165);
...
(2, 'besok akan diadakan infaq', 44, 165, '2021-06-14 22:12:50'),
(3, 'Mari kita doakan saudara kita yang sedang terkena COVID - 19 di yayasan al-fath', 40, 165, '2021-06-15 08:57:26'),
(4, 'kepada seluruh anggota grup ini, mohon untuk donasi seikhlasnya bagi saudara saudari kita yang sedang terkena musibah yang terjadi di desa Cilacap', 40, 165, '2021-06-15 09:01:28'),
(5, 'Mohon doa nya untuk keluarga Asep yang akan menunaikan ibadah haji pada hari Kamis minggu ini', 42, 165, '2021-06-15 11:21:45'),
(6, 'd', 40, 165, '2021-06-30 22:38:36'),
(7, 'doakan untuk negara kita yang sedang naik naiknya kasus COVID 19, semoga kedepannya lebih baik ya teman2', 40, 165, '2021-06-30 22:39:18');
...
(28, 'Baru saja memposting', 40, 146, '2021-06-14 02:54:15'),
(29, 'Telah Bergabung', 44, 144, '2021-06-14 22:11:25'),
(30, 'Telah Bergabung', 44, 146, '2021-06-14 22:11:50'),
(31, 'Telah Bergabung', 44, 154, '2021-06-14 22:12:08'),
(32, 'Telah Dikeluarkan', 44, 154, '2021-06-14 22:12:15'),
(33, 'Mengumumkan informasi baru', 44, 165, '2021-06-14 22:12:50'),
(34, 'Baru saja memposting', 44, 146, '2021-06-14 22:17:14'),
(35, 'Baru saja memposting', 44, 146, '2021-06-14 22:17:44'),
(36, 'Telah Bergabung', 40, 154, '2021-06-15 08:55:49'),
(37, 'Mengumumkan informasi baru', 40, 165, '2021-06-15 08:57:26'),
(38, 'Mengumumkan informasi baru', 40, 165, '2021-06-15 09:01:28'),
(39, 'Baru saja memposting', 40, 165, '2021-06-15 09:25:58'),
(40, 'Telah Dikeluarkan', 40, 154, '2021-06-15 09:32:24'),
(41, 'Telah Bergabung', 42, 144, '2021-06-15 11:20:28'),
(42, 'Telah Bergabung', 42, 146, '2021-06-15 11:20:33'),
(43, 'Mengumumkan informasi baru', 42, 165, '2021-06-15 11:21:45'),
(44, 'Baru saja memposting', 40, 144, '2021-06-15 11:53:13'),
(45, 'Mengumumkan informasi baru', 40, 165, '2021-06-30 22:38:36'),
(46, 'Mengumumkan informasi baru', 40, 165, '2021-06-30 22:39:18');
...
(29, 'Al-kahfi', 40, 165, '60c80fb654c28.mp4', '<div class=\"video-wrapper\"><video class=\"post-video\" controls><source src=http://localhost/myvoqu/assets_user/file_upload/60c80fb654c28.mp4 type=\"video/mp4\"></video></div>', '2021-06-15 09:25:58', NULL);
...
(40, 'HOTS 325', 'Grup ikhwan', 'default.png', 165),
(41, 'Hots 254', 'Grup Ukhti', 'default.png', 161),
(42, 'HOTS 192', 'Grup Akhi', 'default.png', 165),
(43, 'HOTS 554', 'Grup inti', 'default.png', 165),
(44, 'HOTS Telu', 'Telkom university', 'default.png', 165);
...
(21, 'Al-Fatihah Ayat 1 - 7', 4, 165, '60dcbe04841df.mp4', '<div class=\"video-wrapper\"><video class=\"post-video\" controls><source src=http://localhost/myvoqu/assets_user/file_upload/60dcbe04841df.mp4 type=\"video/mp4\"></video></div>', '2021-07-01 01:55:00');
...
INSERT INTO `materi_comment` (`id_m_comment`, `comment`, `id_user`, `id_materi`, `created_at`) VALUES
(14, 'Wow bagus', 165, 21, '2021-07-01 14:27:46');
...
(472, 'Menyukai postingan anda', '1623677555', 293, 165, 144),
(473, 'Menyukai postingan anda', '1623677715', 24, 165, 144),
(474, 'Menyukai postingan anda', '', 300, 154, 0),
(475, 'Menyukai postingan anda', '', 301, 161, 0);
...
(271, 1, '1623677555', 293, 165, 144),
(272, 1, '1623677715', 24, 165, 144),
(273, 2, '', 300, 154, 0),
(274, 2, '', 301, 161, 0);
...
(146, 144, 'Yuk Baca Al Quran', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(147, 144, 'yuk tunggu apalagi? Ngaji bareng aku deh', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(148, 144, 'Al Muzammil 17 by Me, hehehe', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(149, 144, '[OOT] Background Aplikasi MyVoQu Mantep ya', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(150, 146, 'Subhanallah, asyik nya membaca Al Quran !!', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(151, 146, 'Anak kecil aja udah jago baca Al Quran!', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(152, 146, 'Free Palestine', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(153, 146, 'Al Muzammil - 9', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(154, 147, 'kaligrafi buatan nurdin memang bagus!', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(155, 147, '', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:28:39'),
(156, 131, 'ADMIN - Zaki', 'jaki@gmail.com', 1, 'ADMIN - Zaki yang baru melakukan update profile menjadi ADMIN - Zakiw', '2021-09-06 19:35:35'),
(157, 131, 'ADMIN - Zakiw', 'jaki@gmail.com', 1, 'ADMIN - Zakiw yang baru melakukan update profile menjadi ADMIN - Zaki', '2021-09-06 19:35:40'),
(158, 154, 'das', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:39:21'),
(159, 161, 'x', '', 0, 'Ada yang baru delete posting', '2021-09-06 19:39:22');
...
(12, 40, 165, 'Al-Fatihah', '1', '7', 'hafalan pertama', '2021-07-01 17:00:00', '2021-06-30 15:55:08');
...
INSERT INTO `user` (`id`, `name`, `gender`, `email`, `image`, `passsword`, `role_id`, `is_active`, `date_created`, `status`, `birthdate`, `city`, `bio`, `work`, `instansi`, `sertif`, `sertif_date`, `verified`) VALUES
(131, 'ADMIN - Zaki', 'Male', 'jaki@gmail.com', 'IMG_2686.JPG', '$2y$10$xP4idTclGpLn6GTn6zGkQOs26IwtkyEm6xvR4cwPjyqdC1cvxVYZW', 1, 1, 1618314853, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(138, 'ADMIN - ABI', 'Male', 'abi@gmail.com', 'v.png', '$2y$10$xP4idTclGpLn6GTn6zGkQOs26IwtkyEm6xvR4cwPjyqdC1cvxVYZW', 1, 1, 1618314853, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(144, 'Asep Sudasep', 'Male', 'asep@gmail.com', 'default_male.png', '$2y$10$xP4idTclGpLn6GTn6zGkQOs26IwtkyEm6xvR4cwPjyqdC1cvxVYZW', 2, 1, 1622989228, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(145, 'Endar Parisian', 'Female', 'endar@gmail.com', 'default_female.png', '$2y$10$oogXwOXrzoc4KCq7vE2kA.yNzPQUpKulqF9L2kR4YBWhbcGZX06iq', 2, 0, 1622989284, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(146, 'Surya Nurhalimah', 'Male', 'surya@gmail.com', 'default_male.png', '$2y$10$xP4idTclGpLn6GTn6zGkQOs26IwtkyEm6xvR4cwPjyqdC1cvxVYZW', 2, 1, 1622989334, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(147, 'Nurdin Bagus', 'Male', 'nurdin@gmail.com', 'default_male.png', '$2y$10$HMvOlhQToVs4TWLOUvbdsOiKS7QwppWm.jNriv8DdA5QYzarmHFXO', 2, 1, 1622989391, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(148, 'Bambang Sibambang', 'Male', 'bambang@gmail.com', 'default_male.png', '$2y$10$3SjuioySLZzEFsaB5/6.HerOCVae7xXsIMfdMkKKlTPusdJM/cAQW', 2, 0, 1622989430, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(149, 'Abizzy Al Tareq', 'Male', 'abizzy@gmail.com', 'default_male.png', '$2y$10$qBt7p6bai3KftmNlxjkMEe40gANj5M05JBYau.XAuXGJNcdXHDZy.', 2, 0, 1622989477, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(150, 'Surinem', 'Female', 'surinem@gmail.com', 'default_female.png', '$2y$10$lOgCUUE8OKxSqYsX2XKNBOKkK8FDvBGNtJUV9AKQZQFyTcuWdFAw2', 2, 0, 1622989504, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(151, 'Dea', 'Female', 'dea@gmail.com', 'default_female.png', '$2y$10$bQEIInl51NElKcoSBwEbL.rCcrZNjncL8VR9IMHDtn17tQMdvYgBS', 2, 1, 1622989521, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(152, 'Sheva', 'Female', 'sheva@gmail.com', 'default_female.png', '$2y$10$xjiTC3KBjsCrxRZeAUOTge3KfpCPW7NUOxSEwSEc8ZjRFtkZPViHS', 2, 1, 1622989558, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(153, 'Tera', 'Female', 'tera@gmail.com', 'default_female.png', '$2y$10$zZKe6FGdQjtFvYup7WrgkeLHvqmRdPEQUb9WHqerWOxi.u84f1Om.', 2, 1, 1622989581, '', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(154, 'Sobaqam', 'Male', 'sobaqam@gmail.com', 'default_male.png', '$2y$10$muO67UKiiyb2eb9taxHrJuZC2Az6Je2Dt/vu84EehnBD/T9UCam22', 2, 1, 1622989608, 'offline-dot', '0000-00-00', '', 'Hello World!', '', NULL, '', NULL, 0),
(155, 'Naam', 'Male', 'naam@gmail.com', 'default_male.png', '$2y$10$Xzd7UjTDftjL/awxNFipruAvvDhHRF1/IDoygBnGTrGgyJL66uWb2', 3, 0, 1622989789, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdbdd0b10d.png', NULL, 0),
(156, 'Hayfa', 'Female', 'hayfa@gmail.com', 'default_female.png', '$2y$10$cuiseINQrQ.rB/Rb5FBX9OK1rOWiMydxVNPIPa8aHQRSb4eJE20oq', 3, 0, 1622989808, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdbf0cfeb7.png', NULL, 0),
(157, 'Outemu', 'Male', 'outemu@gmail.com', 'default_male.png', '$2y$10$4VVUwAOovLOZSXZRrCYP1eKC/qsXu8Glw1HfjFUklTjv1/i0s73BC', 3, 0, 1622989831, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdc06e61d1.png', NULL, 0),
(158, 'Gofar', 'Male', 'gofar@gmail.com', 'default_male.png', '$2y$10$qHYoYWrei4mQpKQjo3ibpuceqUSsZWze9VKXu/9OSTqdwSqFEU3Ry', 3, 0, 1622989900, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdc4c4e6f3.png', NULL, 0),
(159, 'Qori', 'Male', 'qori@gmail.com', 'default_male.png', '$2y$10$bcW3p8iSFaCzceu1yUci0eKF/sE34Bc/RK12fcRz6YZXdYe9P2LYa', 3, 1, 1622989931, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdc6b7559f.png', NULL, 0),
(160, 'Kailh', 'Male', 'kailh@gmail.com', 'default_male.png', '$2y$10$QbAJbH5pBfk.nxPxxglglehQjT4WhAYeGpTQK38DIvp58yeiiWSV.', 3, 0, 1622989960, '', '0000-00-00', '', 'Hello World!', '', NULL, '60bcdc88e0096.jpeg', NULL, 0),
(161, 'Artisan', 'Female', 'artisan@gmail.com', 'default_female.png', '$2y$10$7RjYCGM5va9xJsvV4dfwbuVK9zcOZ5ST8QZJKmH8RYXGmJA4v3ukq', 3, 1, 1622990006, 'online-dot', '0000-00-00', '', 'Hello World!', '', 'ANNUR', '60bcdcb68950e.png', NULL, 1),
(162, 'Hipyo', 'Female', 'hipyo@gmail.com', 'default_female.png', '$2y$10$opcnZCSZgDsLvCfPMi950.fusqk.pyGeCGa9Jtd4S2vbjysOn/jgy', 3, 0, 1622990043, '', '0000-00-00', '', 'Hello World!', '', 'ISTIQLAL', '60bcdcdb7b4db.png', NULL, 1),
(163, 'Avilla', 'Female', 'avilla@gmail.com', 'default_female.png', '$2y$10$j4Jenlp4YZAgNQcUCtEwZ.8te1I8mcWCnU8u5GNrBbhgYD3o2yROe', 3, 1, 1622990095, '', '0000-00-00', '', 'Hello World!', '', 'ISTIQLAL', '60bcdd0fe3065.png', NULL, 1),
(164, 'Himalaya', 'Female', 'himalaya@gmail.com', 'default_female.png', '$2y$10$8RryDm8w0uOl/Hk0542eAeoqWugjzMvPPQzRNeKVyiXwFvPSG5vya', 3, 0, 1622990138, '', '0000-00-00', '', 'Hello World!', '', 'HOTS', '60bcdd3a1526e.jpg', NULL, 1),
(165, 'Ustad Zaki', 'Male', 'zack.ridzi@gmail.com', 'default_male.png', '$2y$10$iThs4gPo8DLHzIH67y8/lu7096Zdmu0VIpbRI5/YhQix4GM85ATqO', 3, 1, 1622990210, 'online-dot', '0000-00-00', '', 'Hello World!', '', 'HOTS', '60bcdd8287cac.png', NULL, 1);
...
ALTER TABLE `materi_comment`
  ADD PRIMARY KEY (`id_m_comment`),
  ADD KEY `FK1_id_user` (`id_user`),
  ADD KEY `FK2_id_materi` (`id_materi`);
...
--
ALTER TABLE `group_notif`
  MODIFY `id_notif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `materi_comment`
  MODIFY `id_m_comment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `notification`
  MODIFY `id_notification` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=476;
...
--
ALTER TABLE `postgen`
  MODIFY `id_posting` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `posting`
--
ALTER TABLE `posting`
  MODIFY `id_posting` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=302;

--
-- AUTO_INCREMENT for table `report`
--
ALTER TABLE `report`
  MODIFY `id_report` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT for table `report_hafalan`
--
ALTER TABLE `report_hafalan`
  MODIFY `id_hafalan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `suka`
--
ALTER TABLE `suka`
  MODIFY `id_suka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
...
--
-- Constraints for table `materi_comment`
--
ALTER TABLE `materi_comment`
  ADD CONSTRAINT `FK1_id_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK2_id_materi` FOREIGN KEY (`id_materi`) REFERENCES `materi` (`id`);

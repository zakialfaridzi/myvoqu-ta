...
<div class="col-md-7">
    ...
    <div class="edit-profile-container">
        <div class="block-title">
            <h4 class="grey"><i class="icon ion-android-checkmark-circle"></i>Ubah profil grup</h4>
            <div class="line"></div>
            <div class="line"></div>
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12" sty>
                            <label for="email">Deskripsi Grup</label>
                            <input id="desc" class="form-control input-group-lg" type="text" name="desc" value="<?= $dg['deskripsi']; ?>" />
                        </div>
                    </div>
                    <button id="submit" type="submit" class="btn btn-primary" style="background-color:#0486FE; ">Simpan Perubahan</button>
                </form>
            </div>
        <?php endforeach; ?>
    </div>

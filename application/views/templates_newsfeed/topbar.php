...
<head>
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-zOtZeaNaY9E2eWja"></script>
        ...
        <nav class="navbar navbar-default navbar-fixed-top menu" style="background-color: #0486FE;">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= base_url('user') ?>"><img src="<?= base_url('assets_login/'); ?>images/mvqq.png" alt="logo" style="width: 150px; margin-top: -10px;" /></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="navbar-form navbar-right hidden-sm">
                        <div class="form-group" style="display: <?= $search; ?>;">
                            ...
                            <input type="text" class="form-control" placeholder="Cari <?= $search_by ?>" style="background-color: white; color: #323232;" id="keyword">
                        </div>
                    </form>

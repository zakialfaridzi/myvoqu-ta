                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="form-group">
                                ...
                                <form action="<?=base_url('library/posting/') . $this->uri->segment('3');?>"
                                    ...
                                    <textarea cols="30" rows="1" class="form-control" placeholder="Ayat Surat"
                                        name="ayat" id="ayat"></textarea>
                                    <?=form_error('ayat', '<small class="text-danger pl-3">', '</small>');?>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-5">
                            <div class="tools">
                                ...
                                <input type="hidden" value="<?=$this->session->userdata('id');?>" name="id_user"
                                    id="id_user">
                                <?php foreach ($idlogin as $id): ?>
                                <input type="text" name="ustad" id="ustad" value="<?=$id['name'];?>" hidden>
                                <?php endforeach;?>

                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-7">
                            <div class="form-group">
                                ...
                                <form action="<?= base_url('profile/posting'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-5 col-sm-5">
                            <div class="tools">
                                ...
                                <button class="btn btn-primary pull-right" style="background-color: #6fb8df;outline: none;">Publish</button>

...
<?php foreach ($posting as $pst) : ?>
	...
	<div class="post-content">
		...
		<?php if ($pst->id_user == $this->session->userdata('id')) : ?>
			...
			<a href="<?= base_url(); ?>user/deletePost/<?= $pst->id_posting; ?>/<?= $pst->fileName ?>" style="text-decoration:none;">Delete</a>
...
<?php foreach ($postgen as $pst) : ?>
	...
	<div class="post-content">
		...
		<div class="post-container">
			...
			<div class="post-detail">
				<div class="user-info">
					<h5><a href="timeline.html" class="profile-link"><?= $pst->name; ?></a>&emsp;<span class="badge badge-pill badge-danger">Admin</span></h5>
					<p class="text-muted">Published on <?= date('d F Y ', $pst->date_post); ?></p>
				</div>
				<div class="line-divider"></div>
				<div class="post-text">

...
<!-- Mirrored from brandio.io/envato/iofrm/html/login5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Jan 2020 17:44:57 GMT -->

<head>
    <link rel="icon" href="<?= base_url('assets_login/images/mvq.png'); ?>">
    <meta charset="UTF-8">
    ...
    <div class="form-body">
        <div class="website-logo">
            <a href="<?= base_url('auth') ?>">
                <div class="">
                    <img class="" src="<?= base_url('assets_login/'); ?>images/mvq.png" alt="">
                </div>
            </a>
        </div>
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <img src="<?= base_url('assets_login/'); ?>images/graphic2.svg" alt="">
                </div>
            </div>